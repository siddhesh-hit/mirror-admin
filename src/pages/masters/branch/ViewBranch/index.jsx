...
const ViewBranch = () => {
  ...
  const fetchData = async () => {
    await getApi(
      `branch?perPage=${pageOptions.current}&perLimit=${pageOptions.page}&name=${pageOptions["name"]}`
    )
      .then((res) => {
        if (res.data.success) {
  ...
  return (
    <div className="content-wrapper pt-4">
      <div className="contentofpages">
        ...
        <h4 className="page-title">• View Branch</h4>
        <TotalEntries
          returnCount={(data) =>
            setPageOptions((prev) => ({
              ...prev,
